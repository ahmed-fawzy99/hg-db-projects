...
Route::group(['middleware' => ['auth', \App\Http\Middleware\isAdmin::class]], function () {
    ...
    // Using Post because this request has a file and Inertia does not support file uploads on PUT
    Route::post('/edit-project', [\App\Http\Controllers\ProjectController::class, 'update'])->name('update-project');
